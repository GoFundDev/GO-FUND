...
UniValue mnbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a GO-FUND initiative\n"
            "  vote-alias         - Vote on a GO-FUND initiative\n"
            "  vote               - Vote on a GO-FUND initiative/budget\n"
...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"gfc-address\" monthy-payment\n"
            ...
            "5. \"gfc-address\":   (string, required) GFC address to send payments to\n"
