...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GO-FUND Core gofund-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  gofund-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gofund transaction") + "\n" +
                               "  gofund-tx [options] -create [commands]   " + _("Create hex-encoded gofund transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gfc transaction
