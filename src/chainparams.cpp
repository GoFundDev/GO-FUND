...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x00000478a13e99a66cb7c119decfef927c87029fc218291596f8eb7e4e18cb68"));
...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Crypto Markets See Flush of Green as Bitcoin Moves Closer to $5,600";
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x4B)(0x19)(0x25).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x4B)(0x1E)(0xB2).convert_to_container<std::vector<unsigned char> >();
        ...
        strSporkKey = "04d74484d4ac799e076c018865aebaac8fbc4d070f2dcc48ec55ebb72dcb99143ba203a87d7518845d4ce07f5785ff7d1ec247fe17c09c577f62f4f618ffab9c11";
        strSporkKeyOld = "04d74484d4ac799e076c018865aebaac8fbc4d070f2dcc48ec55ebb72dcb99143ba203a87d7518845d4ce07f5785ff7d1ec247fe17c09c577f62f4f618ffab9c11";
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet gofund addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet gofund script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet gofund BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet gofund BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet gofund BIP44 coin type is '1' (All coin's testnet default)
