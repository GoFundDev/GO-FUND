...
// Copyright (c) 2016-2018 The GFCX developers
...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("GFC Stake");
    case TransactionRecord::StakeZGFC:
        return tr("zGFC Stake");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted GFC to zGFC");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zGFC");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received GFC from zGFC");
    case TransactionRecord::ZerocoinSpend_Change_zGfc:
        return tr("Minted Change as zGFC from zGFC Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zGFC to GFC");
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zGfc:
        return tr("Anonymous (zGFC Transaction)");
    case TransactionRecord::StakeZGFC:
        return tr("Anonymous (zGFC Stake)");
    case TransactionRecord::SendToSelf:
    default:
