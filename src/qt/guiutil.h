...
/** Utility functions used by the GO-FUND Qt UI.
 */
namespace GUIUtil
{
...
// Render gfc addresses in monospace font
...
// Parse "gfc:" URI into recipient object, return true on successful parsing
