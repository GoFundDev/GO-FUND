                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GoFund Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GoFund Core"), this);
    aboutAction->setStatusTip(tr("Show information about GoFund Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GoFund"));
    ...
    openAction->setStatusTip(tr("Open a GoFund: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GoFund Core help message to get a list with possible GoFund command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GoFund Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GoFund network", "", count));
}
...
{
    QString strTitle = tr("GoFund Core"); // default title
