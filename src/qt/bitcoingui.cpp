                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GO-FUND Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GFC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gfc: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GO-FUND Core"), this);
    aboutAction->setStatusTip(tr("Show information about GO-FUND Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GO-FUND"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GFC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GFC addresses"));
    ...
    openAction->setStatusTip(tr("Open a GO-FUND: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GO-FUND Core help message to get a list with possible GO-FUND command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GO-FUND Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GO-FUND network", "", count));
}
...
{
    QString strTitle = tr("GO-FUND Core"); // default title
