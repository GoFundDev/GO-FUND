...
This means one can have an always-on gofundd instance running, and another local gofundd/gofund-qt instance which connects to this node and receives blocks from it.
